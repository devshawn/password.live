...
describe("passwordReducer", () => {
    it("should return state for PASSWORD_FETCH_SUCCESS", () => {
        // arrange & act
        let result = passwordReducer(getTestState(), { type: PASSWORD_FETCH_SUCCESS, payload: { password: "updated-advanced-password" } })

        // assert
        expect(result.password).toEqual("updated-advanced-password")
    })
